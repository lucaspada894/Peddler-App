...
/**
 * MarketAdapter provides corresponding adaptation for MarketPage.
 */
public class MarketAdapter extends ArrayAdapter<String> {
    ...
    //Initializing
    public MarketAdapter(Context context, ArrayList<String> n, ArrayList<String> c, int[] i){

        super(context, R.layout.markets_row);
        icons = i;
        names = n;
        descriptions = c;
        currCtxt = context;
    ...
    public View getView(int pos, View targetV, ViewGroup parent){
        ...
        if(targetV == null) {
            ...
            targetV = currInfltr.inflate(R.layout.markets_row, parent, false);

            //res look-up
            vc.ic = (ImageView) targetV.findViewById(R.id.pruIcon);
            vc.na = (TextView) targetV.findViewById(R.id.pruName);
            vc.ds = (TextView) targetV.findViewById(R.id.pruDes);
            targetV.setTag(vc);
